...
constexpr UINT SCI_MARKERDEFINE = 2040;
constexpr UINT SCI_MARKERSETFORE = 2041;
constexpr UINT SCI_MARKERSETBACK = 2042;
...
constexpr UINT SCI_MARKERSETALPHA = 2476;
...
constexpr UINT SCI_MARKERSETLAYER = 2735;
